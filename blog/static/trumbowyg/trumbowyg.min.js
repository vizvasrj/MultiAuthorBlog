...
(jQuery.trumbowyg = {
  ...
  Object.defineProperty(jQuery.trumbowyg, "defaultOptions", {
    value: {
      ...
      prefix: "trumbowyg-",
      tagClasses: { h1: null, h2: null, h3: null, h4: null, p: null },
      semantic: !0,
  ...
  (function (e, t, n, a) {
    ...
    var i = function (o, r) {
      ...
      (i.doc = o.ownerDocument || n),
        ...
        (i.$c = a(o)),
        (r = r || {}),
        null != r.lang || null != l.langs[r.lang]
      ...
      if (
        ((i.hasSvg = d !== !1),
        d !== !1 && (l.svgAbsoluteUseHref || 0 === a("#" + s, i.doc).length))
      ) {
        if (null == d) {
          var c = a("script[src]");
          c.each(function (e, t) {
        ...
        if (null == d)
          ...
          var u = i.doc.createElement("div");
          (u.id = s),
            i.doc.body.insertBefore(u, i.doc.body.childNodes[0]),
            a.ajax({
              async: !0,
              type: "GET",
              ...
              complete: null,
              success: function (e) {
                u.innerHTML = new XMLSerializer().serializeToString(
                  e.documentElement
                );
              },
            });
      ...
      var g = i.doc.querySelector("base")
        ? t.location.href.split(/[?#]/)[0]
        : "";
      i.svgPath = l.svgAbsoluteUseHref ? d : g;
      var f = i.lang.header,
        h = function () {
      ...
      (i.btnsDef = {
        ...
        undo: { isSupported: h, key: "Z" },
        redo: { isSupported: h, key: "Y" },
        p: { fn: "formatBlock" },
        blockquote: { fn: "formatBlock" },
        h1: { fn: "formatBlock", title: f + " 1" },
        h2: { fn: "formatBlock", title: f + " 2" },
        h3: { fn: "formatBlock", title: f + " 3" },
        h4: { fn: "formatBlock", title: f + " 4" },
        h5: { fn: "formatBlock", title: f + " 5" },
        h6: { fn: "formatBlock", title: f + " 6" },
        subscript: { tag: "sub" },
        superscript: { tag: "sup" },
        bold: { key: "B", tag: "b" },
        italic: { key: "I", tag: "i" },
        ...
        (i.isIE =
          e.userAgent.indexOf("MSIE") !== -1 ||
          e.appVersion.indexOf("Trident/") !== -1),
        (i.isMac = e.platform.toUpperCase().indexOf("MAC") !== -1),
        i.init();
    };
    i.prototype = {
        ...
        e.$ed
          ...
          .on("keydown", function (t) {
            ...
            if (
              ...
              i = !0;
              var o = e.keys[String.fromCharCode(t.which).toUpperCase()];
              try {
                return e.execCmd(o.fn, o.param), !1;
              } catch (a) {}
            }
          })
          ...
          .on("keyup compositionend", function (t) {
            ...
            if (!(n >= 37 && n <= 40)) {
              if (
                ...
                if (i || 17 === n)
                  "undefined" == typeof t.which && e.semanticCode(!1, !1, !0);
                else {
      ...
      semanticTag: function (e, t, n) {
        ...
        n && ((e = o), (o = i)),
          a(e, this.$ed).each(function () {
            ...
            r.range.startContainer.parentNode &&
              r.range.startContainer.parentNode === this &&
              (e = !0);
            var i = a("<" + o + "/>");
            i.insertBefore(n),
              t &&
        ...
        try {
          ...
          try {
            ...
            "insertHorizontalRule" === e
              ...
              i.semanticCode(!1, !0);
            try {
              var d = t.getSelection().focusNode;
              a(t.getSelection().focusNode.parentNode).hasClass(
                "trumbowyg-editor"
              ) || (d = t.getSelection().focusNode.parentNode);
              var c = i.o.tagClasses[n];
              if (c) for (var u = 0; u < c.length; u += 1) a(d).addClass(c[u]);
            } catch (g) {}
          }
          "dropdown" !== e &&
      ...
      openModal: function (e, n, i) {
        ...
        s.$overlay.one("click", function () {
          return d.trigger(r), !1;
        });
        var c;
        c = i
          ? a("<form/>", { action: "", html: n })
              .on("submit", function () {
                return d.trigger(o), !1;
              })
              .on("reset", function () {
                return d.trigger(r), !1;
              })
          ...
          : n;
        var u = a("<div/>", { class: l + "modal-box", html: c })
          .css({
