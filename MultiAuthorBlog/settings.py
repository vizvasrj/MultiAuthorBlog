...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            # 'libraries': {
            #     'translates_tags': 'blog.templatetags.translates_tags',
            # }
        },
    },
]
...
TAGGIT_AUTOSUGGEST_MODELS = ('mytag', 'MyCustomTag')
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=65),
    'REFRESH_TOKEN_LIFETIME': timedelta(days=65), # login date like life span
