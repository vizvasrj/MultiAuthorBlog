...
from .serializers import JTPostSerializer
...
class JTPostView(generics.ListCreateAPIView):
    queryset = JapaneseTranslatedPost.objects.all()
    serializer_class = JTPostSerializer
...
class JTPostDetail(generics.RetrieveUpdateDestroyAPIView):
    queryset = JapaneseTranslatedPost.objects.all()
    serializer_class = JTPostSerializer
    name = 'jp-post-list'
    permission_class = (
    ...
    def perform_update(self, serializer, instance):
        ...
        data = serializer.validated_data
        post_id = data['post']['id']
        p = JapaneseTranslatedPost.objects.get(id=path_id)
