...
class ArabicTranslatedTag(models.Model):
    tag = models.ForeignKey(
        MyCustomTag,
        related_name='arabic_tags',
...
class ArabicTranslatedPost(models.Model):
    ...
    edited_by = models.ManyToManyField(
        User,
        related_name='arabic_translate_edited_by'
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    users_like = models.ManyToManyField(
        User,
        related_name='arabic_translated_users_like',
        blank=True
    )
    ...
    bookmark_list = models.ManyToManyField(
        User,
        related_name='arabic_translated_bookmark',
        blank=True
    )
...
class ArabicTranslatedAbout(models.Model):
    post = models.ForeignKey(
        AboutPost,
        related_name='arabic_about',
        on_delete=models.CASCADE
    )
