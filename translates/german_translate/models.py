...
class GermanTranslatedTag(models.Model):
    tag = models.ForeignKey(
        MyCustomTag,
        related_name='german_tags',
...
class GermanTranslatedPost(models.Model):
    post = models.ForeignKey(
        Post,
        related_name='german_translated_post',
        on_delete=models.CASCADE
    )
    ...
    edited_by = models.ManyToManyField(
        User,
        related_name='german_translate_edited_by'
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    users_like = models.ManyToManyField(
        User,
        related_name='german_translated_users_like',
        blank=True
    )
    ...
    bookmark_list = models.ManyToManyField(
        User,
        related_name='german_translated_bookmark',
        blank=True
    )
...
class GermanTranslatedAbout(models.Model):
    post = models.ForeignKey(
        AboutPost,
        related_name='german_about',
        on_delete=models.CASCADE
    )
