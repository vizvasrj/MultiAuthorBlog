...
class SpanishTranslatedTag(models.Model):
    tag = models.ForeignKey(
        MyCustomTag,
        related_name='spanish_tags',
...
class SpanishTranslatedPost(models.Model):
    post = models.ForeignKey(
        Post,
        related_name='spanish_translated_post',
        on_delete=models.CASCADE
    )
    ...
    edited_by = models.ManyToManyField(
        User,
        related_name='spanish_translate_edited_by'
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    users_like = models.ManyToManyField(
        User,
        related_name='spanish_translated_users_like',
        blank=True
    )
    ...
    bookmark_list = models.ManyToManyField(
        User,
        related_name='spanish_translated_bookmark',
        blank=True
    )
    audio = models.FileField(
        upload_to='spanish_speech/',
        blank=True
    )
